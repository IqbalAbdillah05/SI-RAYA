...
<head>
    ...
    <title>@yield('title', 'Dosen SI-RAYA STAI RAYA')</title>
...
<body>
    ...
    <nav class="top-navbar">
        <div class="navbar-container">
            <!-- Brand Logo -->
            <a href="{{ route('dosen.dashboard') }}" class="navbar-brand">
            ...
            <div class="navbar-menu">
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('dosen.presensi.index') }}" class="dropdown-item">
                            <i class="fas fa-calendar-check"></i>
                            <span>Presensi Hari Ini</span>
                        </a>
                        <a href="{{ route('dosen.presensi.riwayat') }}" class="dropdown-item">
                ...
                <div class="nav-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="{{ route('dosen.presensiMahasiswa.index') }}" class="dropdown-item">
                            <i class="fas fa-clipboard-check"></i>
                            <span>Kelola Presensi</span>
                        </a>
                        <a href="{{ route('dosen.presensiMahasiswa.riwayat') }}" class="dropdown-item">
                ...
                <a href="{{ route('dosen.inputNilai.index') }}" class="nav-link {{ request()->routeIs('dosen.inputNilai.*') ? 'active' : '' }}">
                    <i class="fas fa-award"></i>
                    <span>Input Nilai</span>
                </a>

                <a href="{{ route('dosen.jadwalMengajar.index') }}" class="nav-link {{ request()->routeIs('dosen.jadwalMengajar.*') ? 'active' : '' }}">
                    <i class="fas fa-calendar-alt"></i>
                    <span>Jadwal Mengajar</span>
                </a>

                <a href="{{ route('dosen.bantuan.index') }}" class="nav-link {{ request()->routeIs('dosen.bantuan.*') ? 'active' : '' }}">
    ...
    <div class="mobile-menu" id="mobileMenu">
        <div class="mobile-nav-section">
            ...
            <a href="{{ route('dosen.dashboard') }}" class="mobile-nav-link {{ request()->routeIs('dosen.dashboard') ? 'active' : '' }}">
                <i class="fas fa-home"></i>
                <span>Beranda</span>
            </a>
        </div>
        ...
        <div class="mobile-nav-section">
            ...
            <a href="{{ route('dosen.presensi.index') }}" class="mobile-nav-link">
                <i class="fas fa-calendar-check"></i>
                <span>Presensi Hari Ini</span>
            </a>
            <a href="{{ route('dosen.presensi.riwayat') }}" class="mobile-nav-link">
                <i class="fas fa-history"></i>
                <span>Riwayat Kehadiran</span>
            </a>
        </div>
        ...
        <div class="mobile-nav-section">
            ...
            <a href="{{ route('dosen.presensiMahasiswa.index') }}" class="mobile-nav-link">
                <i class="fas fa-clipboard-check"></i>
                <span>Kelola Presensi</span>
            </a>
            <a href="{{ route('dosen.presensiMahasiswa.riwayat') }}" class="mobile-nav-link">
                <i class="fas fa-clock"></i>
                <span>Riwayat Mahasiswa</span>
            </a>
        </div>
        ...
        <div class="mobile-nav-section">
            ...
            <a href="{{ route('dosen.inputNilai.index') }}" class="mobile-nav-link {{ request()->routeIs('dosen.inputNilai.*') ? 'active' : '' }}">
                <i class="fas fa-award"></i>
                <span>Input Nilai</span>
            </a>
            <a href="{{ route('dosen.jadwalMengajar.index') }}" class="mobile-nav-link {{ request()->routeIs('dosen.jadwalMengajar.*') ? 'active' : '' }}">
                <i class="fas fa-calendar-alt"></i>
                <span>Jadwal Mengajar</span>
            </a>
        </div>
        ...
        <div class="mobile-nav-section">
            ...
            <a href="{{ route('dosen.bantuan.index') }}" class="mobile-nav-link {{ request()->routeIs('dosen.bantuan.*') ? 'active' : '' }}">
                <i class="fas fa-question-circle"></i>
    ...
    <main class="main-content">
        ...
        <div class="breadcrumb-container">
            <div class="breadcrumb">
                <a href="{{ route('dosen.dashboard') }}" class="breadcrumb-item">
                    <i class="fas fa-home"></i>
                </a>
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-links">
                ...
                <a href="{{ route('dosen.bantuan.dokumentasi') }}" class="footer-link">Dokumentasi</a>
                <a href="{{ route('dosen.bantuan.kontak') }}" class="footer-link">Kontak</a>
            </div>
        </div>
    </footer>
