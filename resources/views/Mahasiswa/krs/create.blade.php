    ...
    <div class="card-info" style="background: linear-gradient(135deg, #0B6623 0%, #0a5a1f 100%); border: none; padding: 24px; border-radius: 12px; margin-bottom: 20px; color: white;">
        <div>
            ...
            <p style="margin: 0; opacity: 0.95; font-size: 14px;">
                Pilih mata kuliah yang akan diambil semester {{ $mahasiswa->semester }}
            </p>
        </div>
    </div>
                ...
                <div class="card-simple">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="semester" value="{{ $mahasiswa->semester }}" readonly>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="matakuliah-item-krs" onclick="toggleMataKuliah({{ $mataKuliah->id }})">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <input type="checkbox" 
                                       ...
                                       {{ in_array($mataKuliah->id, old('mata_kuliah_ids', [])) ? 'checked' : '' }}>
            ...
            <div class="col-lg-4">
                <div class="total-sks-card-krs">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('mahasiswa.krs.index') }}" class="btn-secondary-krs">
