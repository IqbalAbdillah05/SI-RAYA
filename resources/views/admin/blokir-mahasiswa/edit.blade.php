...
@section('title', 'Edit Blokir Mahasiswa')
...
<div class="blokir-mahasiswa-edit">
    ...
    <div class="form-container">
        <form action="{{ route('admin.blokir-mahasiswa.update', $blokirMahasiswa) }}" method="POST" id="blokirForm" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                        ...
                        <select name="mahasiswa_id" id="mahasiswa_id" class="form-control" required>
                            ...
                            @foreach($mahasiswas as $mahasiswa)
                                <option value="{{ $mahasiswa->id }}" 
                                    ...
                                    {{ $blokirMahasiswa->mahasiswa_id == $mahasiswa->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="prodi_id" id="prodi_id" value="{{ $blokirMahasiswa->prodi_id }}">
                        <input type="text" id="prodi" class="form-control" readonly 
                            value="{{ $blokirMahasiswa->prodi->nama_prodi }}">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <textarea name="keterangan" class="form-control" rows="3" placeholder="Alasan pemblokiran">{{ $blokirMahasiswa->keterangan }}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Tanggal Blokir</label>
                        <input type="date" name="tanggal_blokir" class="form-control" 
                            value="{{ $blokirMahasiswa->tanggal_blokir->format('Y-m-d') }}">
                    </div>

                    <div class="form-group">
                        <label>Status Blokir <span class="required">*</span></label>
                        <select name="status_blokir" class="form-control" required>
                            <option value="Diblokir" {{ $blokirMahasiswa->status_blokir == 'Diblokir' ? 'selected' : '' }}>Diblokir</option>
                            <option value="Dibuka" {{ $blokirMahasiswa->status_blokir == 'Dibuka' ? 'selected' : '' }}>Dibuka</option>
                        </select>
