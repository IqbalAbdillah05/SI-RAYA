...
<div class="mata-kuliah-detail">
    ...
    <div class="detail-wrapper">
        <div class="detail-card">
            <div class="detail-header">
                ...
                <span class="badge-jenis-mk badge-{{ $mataKuliah->jenis_mk }}">
            ...
            <div class="detail-body">
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $mataKuliah->kode_matakuliah }}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Program Studi</span>
                    <span class="detail-value">{{ $mataKuliah->prodi->nama_prodi }}</span>
                </div>
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $mataKuliah->js ?? '-' }}</span>
                </div>

                <div class="detail-row">
                    <span class="detail-label">Semester</span>
                    <span class="detail-value">{{ $mataKuliah->semester }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="action-section">
        <a href="{{ route('admin.manajemen-mata-kuliah.edit', $mataKuliah->id) }}" class="btn btn-primary">
