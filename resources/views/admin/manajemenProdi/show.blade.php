...
<div class="prodi-detail">
    ...
    <div class="detail-card">
        <div class="detail-header">
            ...
            <span class="badge-jenjang">{{ $prodi->jenjang }}</span>
        </div>
        ...
        <div class="detail-body">
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $prodi->kode_prodi }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Nama Prodi</span>
                    <span class="detail-value">{{ $prodi->nama_prodi }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Jenjang</span>
                    <span class="detail-value">
                        <span class="badge-jenjang small">{{ $prodi->jenjang }}</span>
                    </span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Ketua Prodi</span>
                    <span class="detail-value">{{ $prodi->ketua_prodi ?? '-' }}</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">NIDN Ketua Prodi</span>
                    <span class="detail-value">{{ $prodi->nidn_ketua_prodi ?? '-' }}</span>
                </div>
            </div>
            ...
            <div class="detail-section">
                ...
                <div class="detail-row">
                    ...
                    <span class="detail-value">{{ $prodi->created_at->format('d M Y, H:i') }} WIB</span>
                </div>
                <div class="detail-row">
                    <span class="detail-label">Terakhir Diupdate</span>
                    <span class="detail-value">{{ $prodi->updated_at->format('d M Y, H:i') }} WIB</span>
                </div>
            </div>
        </div>

        <div class="detail-footer">
            <a href="{{ route('admin.manajemen-prodi.edit', $prodi->id) }}" class="btn btn-primary">
                <i class="fas fa-edit"></i> Edit
            </a>
            <form action="{{ route('admin.manajemen-prodi.destroy', $prodi->id) }}" 
                  method="POST" 
