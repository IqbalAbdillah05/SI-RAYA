...
<div class="presensi-show">
                ...
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="detail-value">
                            @if($presensi->mahasiswa && $presensi->mahasiswa->mahasiswaProfile)
                                {{ $presensi->mahasiswa->mahasiswaProfile->nama_lengkap }}
                            @else
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $presensi->mahasiswa->nim ?? '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $presensi->mataKuliah->nama_matakuliah ?? '-' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Program Studi</span>
                        <span class="detail-value">{{ $presensi->prodi->nama_prodi ?? '-' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Waktu Presensi</span>
                        <span class="detail-value">{{ $presensi->waktu_presensi ? $presensi->waktu_presensi->format('d F Y, H:i') : '-' }}</span>
                    </div>
                    <div class="detail-item">
            ...
            <div class="card-body">
                <div class="detail-grid">
                    <div class="detail-item">
                        ...
                        <span class="detail-value">{{ $presensi->created_at ? $presensi->created_at->format('d F Y, H:i') : '-' }}</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Diperbarui Pada</span>
                        <span class="detail-value">{{ $presensi->updated_at ? $presensi->updated_at->format('d F Y, H:i') : '-' }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="action-section">
        <a href="{{ route('admin.manajemen-presensi-mahasiswa.edit', $presensi) }}" class="btn btn-primary">
            <i class="fas fa-edit"></i> Edit
        </a>
        <form action="{{ route('admin.manajemen-presensi-mahasiswa.destroy', $presensi) }}" 
              method="POST" 
