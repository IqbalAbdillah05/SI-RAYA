...
<div class="jadwal-management">
    ...
    <div class="page-header">
        ...
        <a href="{{ route('admin.jadwal-mahasiswa.create') }}" class="btn btn-primary">
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <strong>{{ $jadwal->mataKuliah->nama_matakuliah ?? '-' }}</strong>
                    </td>
                    <td>
                        <div class="user-info">
                            <div>
                    ...
                    <td>
                        ...
                        <small>{{ $jadwal->tahun_ajaran }}</small>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <a href="{{ route('admin.jadwal-mahasiswa.show', $jadwal->id) }}" class="btn-action btn-view" title="Lihat Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.jadwal-mahasiswa.edit', $jadwal->id) }}" class="btn-action btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.jadwal-mahasiswa.destroy', $jadwal->id) }}" method="POST" style="display: inline;" class="delete-form">
                                @csrf
                                @method('DELETE')
    ...
    <!-- Pagination Info -->
    @if($jadwalList->hasPages() || $jadwalList->total() > 0)
    <div class="pagination-wrapper">
        <div class="pagination-info">
            Menampilkan {{ $jadwalList->firstItem() ?? 0 }} sampai {{ $jadwalList->lastItem() ?? 0 }} dari {{ $jadwalList->total() }} data
        </div>
