...
<?php $__env->startSection('title', 'Manajemen Nilai Mahasiswa'); ?>
...
<div class="nilai-management">
    ...
    <div class="controls">
        <div class="left-controls">
            ...
            <div class="export-buttons">
                <a href="<?php echo e(route('admin.manajemen-nilai-mahasiswa.export', request()->all())); ?>" 
        ...
        <table class="data-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e($nilai->matkul_name); ?></td>
                    <td><?php echo e($nilai->dosen->nama_lengkap ?? '-'); ?></td>
                    <td>
                        <span class="badge badge-info"><?php echo e(number_format($nilai->nilai_angka, 2)); ?></span>
                    </td>
                    <td>
                        <span class="badge 
                    ...
                    <td><?php echo e(number_format($nilai->nilai_indeks, 2)); ?></td>
                    <td><?php echo e($nilai->semester); ?></td>
                    <td><?php echo e($nilai->tahun_ajaran); ?></td>
                    <td>
                        <div class="action-buttons">
                            <a href="<?php echo e(route('admin.manajemen-nilai-mahasiswa.show', $nilai->id)); ?>" 
                               class="btn-action btn-view" title="Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?php echo e(route('admin.manajemen-nilai-mahasiswa.edit', $nilai->id)); ?>" 
                               class="btn-action btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('admin.manajemen-nilai-mahasiswa.destroy', $nilai->id)); ?>" 
                                  method="POST" 
    ...
    <!-- Pagination -->
    <?php if($nilaiList->hasPages() || $nilaiList->total() > 0): ?>
    <div class="pagination-wrapper">
        <div class="pagination-info">
            Menampilkan <?php echo e($nilaiList->firstItem() ?? 0); ?> sampai <?php echo e($nilaiList->lastItem() ?? 0); ?> dari <?php echo e($nilaiList->total()); ?> data
        </div>
        <div class="pagination-links">
            <?php echo e($nilaiList->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/manajemenNilaiMahasiswa/index.blade.php ENDPATH**/ ?>