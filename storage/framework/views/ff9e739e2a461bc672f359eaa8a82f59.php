...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin SI-RAYA STAI RAYA'); ?></title>
...
<body>
    <div class="app-container">
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                <img src="<?php echo e(asset('images/stai-raya-logo.png')); ?>" alt="STAI RAYA Logo">
                <h2>Admin SI-RAYA</h2>
            </div>
            ...
            <nav>
                <ul class="sidebar-menu">
                    <li class="sidebar-menu-group">
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" data-menu-item="dashboard">
                    ...
                    <li>
                        <div class="sidebar-submenu" id="user-management">
                            <div class="sidebar-submenu-content">
                                <a href="<?php echo e(route('admin.manajemen-user.index')); ?>" class="sidebar-menu-item" data-menu-item="user-management">
    ...
    <div class="sidebar-submenu-content">
        <a href="<?php echo e(route('admin.lokasi.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.lokasi.*') ? 'active' : ''); ?>" data-menu-item="location-management">
...
<li>
    <div class="sidebar-submenu" id="academic-management">
        <div class="sidebar-submenu-content">
            <a href="<?php echo e(route('admin.manajemen-prodi.index')); ?>" 
               class="sidebar-menu-item" 
               data-menu-item="academic-prodi">
                <i class="fas fa-university"></i> Manajemen Prodi
            </a>
            <a href="<?php echo e(route('admin.manajemen-mata-kuliah.index')); ?>" 
               class="sidebar-menu-item" 
                ...
                <i class="fas fa-book"></i> Manajemen Mata Kuliah
                    ...
                    <li>
                        <div class="sidebar-submenu" id="lecturer-management">
                            <div class="sidebar-submenu-content">
                                <a href="<?php echo e(route('admin.manajemen-presensi-dosen.index')); ?>" class="sidebar-menu-item" data-menu-item="lecturer-absen">
                    ...
                    <li>
                        <div class="sidebar-submenu" id="student-management">
                            <div class="sidebar-submenu-content">
                                <a href="<?php echo e(route('admin.manajemen-presensi-mahasiswa.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.manajemen-presensi-mahasiswa.*') ? 'active' : ''); ?>" data-menu-item="student-absen">
                                    <i class="fas fa-calendar-alt"></i> Manajemen Presensi Mahasiswa
                                </a>
                                <a href="<?php echo e(route('admin.manajemen-nilai-mahasiswa.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.manajemen-nilai-mahasiswa.*') ? 'active' : ''); ?>" data-menu-item="student-grades">
                                    <i class="fas fa-chart-bar"></i> Manajemen Nilai Mahasiswa
                                </a>
                                <a href="<?php echo e(route('admin.jadwal-mahasiswa.index')); ?>"class="sidebar-menu-item <?php echo e(request()->routeIs('admin.jadwal-mahasiswa.*') ? 'active' : ''); ?>"data-menu-item="student-schedule">
                                    <i class="fas fa-calendar-week"></i> Jadwal Mahasiswa
                                </a>
                                <a href="<?php echo e(route('admin.khs.index')); ?>" class="sidebar-menu-item" data-menu-item="student-khs">
                                    <i class="fas fa-file-alt"></i> KHS Mahasiswa
                                </a>
                                <a href="<?php echo e(route('admin.krs.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.krs.*') ? 'active' : ''); ?>" data-menu-item="student-krs">
                                    <i class="fas fa-file-alt"></i> KRS Mahasiswa
                                </a>
                                <a href="<?php echo e(route('admin.blokir-mahasiswa.index')); ?>" class="sidebar-menu-item <?php echo e(request()->routeIs('admin.blokir-mahasiswa.*') ? 'active' : ''); ?>" data-menu-item="student-block">
                    ...
                    <li class="sidebar-menu-group">
                        <a href="<?php echo e(route('logout')); ?>" class="sidebar-menu-item"
...
<?php /**PATH C:\laragon\www\si-raya\resources\views/layouts/admin.blade.php ENDPATH**/ ?>