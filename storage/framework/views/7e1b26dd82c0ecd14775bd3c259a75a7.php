...
<div class="admin-dashboard">
    ...
    <div class="dashboard-stats">
        <div class="stat-card">
            ...
            <div class="stat-content">
                ...
                <p class="stat-number"><?php echo e($totalMahasiswa ?? 0); ?></p>
                <a href="<?php echo e(route('admin.manajemen-user.index')); ?>?role=mahasiswa" class="stat-link">Lihat Detail <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3>Total Dosen</h3>
                <p class="stat-number"><?php echo e($totalDosen ?? 0); ?></p>
                <a href="<?php echo e(route('admin.manajemen-user.index')); ?>?role=dosen" class="stat-link">Lihat Detail <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
        ...
        <div class="stat-card">
            ...
            <div class="stat-content">
                <h3>Total Admin</h3>
                <p class="stat-number"><?php echo e($totalAdmin ?? 0); ?></p>
                <a href="<?php echo e(route('admin.manajemen-user.index')); ?>?role=admin" class="stat-link">Lihat Detail <i class="fas fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
                ...
                <div class="krs-stats">
                    <div class="krs-stat-item">
                        <div class="krs-stat-header">
                            ...
                            <span class="krs-number total"><?php echo e($totalKrs); ?></span>
                        </div>
                    ...
                    <div class="krs-stat-item">
                        <div class="krs-stat-header">
                            ...
                            <span class="krs-number warning"><?php echo e($krsMenunggu); ?></span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill warning" style="width: <?php echo e($totalKrs > 0 ? ($krsMenunggu / $totalKrs * 100) : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="krs-stat-item">
                        <div class="krs-stat-header">
                            ...
                            <span class="krs-number success"><?php echo e($krsDisetujui); ?></span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill success" style="width: <?php echo e($totalKrs > 0 ? ($krsDisetujui / $totalKrs * 100) : 0); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="krs-stat-item">
                        <div class="krs-stat-header">
                            ...
                            <span class="krs-number danger"><?php echo e($krsDitolak); ?></span>
                        </div>
                        <div class="progress-bar">
                            <div class="progress-fill danger" style="width: <?php echo e($totalKrs > 0 ? ($krsDitolak / $totalKrs * 100) : 0); ?>%"></div>
                        </div>
                    </div>
                </div>
                
                <div style="margin-top: 15px; text-align: center;">
                    <a href="<?php echo e(route('admin.krs.index')); ?>" class="btn-link">
                ...
                <div class="statistics-grid">
                    <div class="stat-item">
                        <div class="stat-circle green">
                            <span class="percentage"><?php echo e($attendancePercentage); ?></span>
                        </div>
                        <p class="stat-label">Kehadiran Mahasiswa</p>
                    </div>
                    <div class="stat-item">
                        <div class="stat-circle blue">
                            <span class="percentage"><?php echo e($lecturerAttendance); ?></span>
                        </div>
    ...
    <div class="card-body">
        <div class="schedule-list">
            <?php if(isset($upcomingSchedules) && count($upcomingSchedules) > 0): ?>
                ...
                <div class="schedule-item">
                    <div class="schedule-time">
                        <span class="date"><?php echo e($schedule->date); ?></span>
                        <span class="time"><?php echo e($schedule->time); ?> - <?php echo e($schedule->end_time); ?></span>
                        <span class="semester">Semester <?php echo e($schedule->semester); ?></span>
                        <span class="year"><?php echo e($schedule->tahun_ajaran); ?></span>
                    </div>
                    <div class="schedule-details">
                        <h4><?php echo e($schedule->subject); ?></h4>
                        <p><?php echo e($schedule->lecturer); ?></p>
                        <span class="location">
                            <i class="fas fa-map-marker-alt"></i> <?php echo e($schedule->room); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>