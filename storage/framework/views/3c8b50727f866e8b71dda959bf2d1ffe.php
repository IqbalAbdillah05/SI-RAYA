...
<div class="presensi-container">
    <div class="card-simple">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select name="semester" id="semesterSelect" class="form-control" required>
                                ...
                                <?php for($i = 1; $i <= 8; $i++): ?>
                                    <option value="<?php echo e($i); ?>" <?php echo e($semester == $i ? 'selected' : ''); ?>>
        ...
        <form action="<?php echo e(route('dosen.presensiMahasiswa.store')); ?>" method="POST" id="presensiForm" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
function loadMataKuliah() {
    ...
    if (prodiId && semester) {
        ...
        const url = `<?php echo e(route('dosen.presensiMahasiswa.getMatakuliah')); ?>?prodi_id=${prodiId}&semester=${semester}`;
    ...
    const url = `<?php echo e(route('dosen.presensiMahasiswa.getMahasiswa')); ?>?prodi_id=${prodiId}&semester=${semester}&matakuliah_id=${matakuliahId}&tanggal=${tanggalPresensi}`;
...
<?php echo $__env->make('layouts.dosen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/dosen/presensiMahasiswa/create.blade.php ENDPATH**/ ?>