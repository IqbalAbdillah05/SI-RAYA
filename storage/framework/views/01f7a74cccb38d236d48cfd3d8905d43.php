...
<?php $__env->startSection('title', 'Isi KRS Baru'); ?>
    ...
    <div class="card-info" style="background: linear-gradient(135deg, #0B6623 0%, #0a5a1f 100%); border: none; padding: 24px; border-radius: 12px; margin-bottom: 20px; color: white;">
        <div>
            ...
            <p style="margin: 0; opacity: 0.95; font-size: 14px;">
                Pilih mata kuliah yang akan diambil semester <?php echo e($mahasiswa->semester); ?>
                ...
                <div class="card-simple">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="semester" value="<?php echo e($mahasiswa->semester); ?>" readonly>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="matakuliah-item-krs" onclick="toggleMataKuliah(<?php echo e($mataKuliah->id); ?>)">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <input type="checkbox" 
                                       ...
                                       <?php echo e(in_array($mataKuliah->id, old('mata_kuliah_ids', [])) ? 'checked' : ''); ?>>
            ...
            <div class="col-lg-4">
                <div class="total-sks-card-krs">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('mahasiswa.krs.index')); ?>" class="btn-secondary-krs">
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/mahasiswa/krs/create.blade.php ENDPATH**/ ?>