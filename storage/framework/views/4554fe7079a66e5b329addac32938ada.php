...
<div class="user-create">
        ...
        <div class="import-cards">
            ...
            <div class="import-card">
                ...
                <div class="import-card-body">
                    ...
                    <form action="<?php echo e(route('admin.manajemen-user.importMahasiswa')); ?>" method="POST" enctype="multipart/form-data" class="import-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="import-actions">
                            <a href="<?php echo e(route('admin.manajemen-user.templateMahasiswa')); ?>" class="btn btn-outline" target="_blank">
            ...
            <div class="import-card">
                ...
                <div class="import-card-body">
                    ...
                    <form action="<?php echo e(route('admin.manajemen-user.importDosen')); ?>" method="POST" enctype="multipart/form-data" class="import-form">
                        <?php echo csrf_field(); ?>
                        <div class="file-input-wrapper">
                        ...
                        <div class="import-actions">
                            <a href="<?php echo e(route('admin.manajemen-user.templateDosen')); ?>" class="btn btn-outline" target="_blank">
                                <i class="fas fa-download"></i> Download Template
                            </a>
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-upload"></i> Upload & Import
    ...
    <div class="form-container">
        <form action="<?php echo e(route('admin.manajemen-user.store')); ?>" method="POST" enctype="multipart/form-data" id="userForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-section">
                ...
                <div class="role-selection">
                    <label class="role-card">
                        <input type="radio" name="role" value="admin" <?php echo e(old('role') == 'admin' ? 'checked' : ''); ?> required>
                    ...
                    <label class="role-card">
                        <input type="radio" name="role" value="dosen" <?php echo e(old('role') == 'dosen' ? 'checked' : ''); ?> required>
                        <div class="role-card-content">
                            <i class="fas fa-chalkboard-teacher"></i>
                            <span>Dosen</span>
                        </div>
                    ...
                    <label class="role-card">
                        <input type="radio" name="role" value="mahasiswa" <?php echo e(old('role') == 'mahasiswa' ? 'checked' : ''); ?> required>
                        <div class="role-card-content">
                            <i class="fas fa-user-graduate"></i>
                            <span>Mahasiswa</span>
                        </div>
            ...
            <div class="form-section" id="adminForm" style="display: none;">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Masukkan Nama Lengkap">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-section" id="dosenForm" style="display: none;">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label>Nama Lengkap <span class="required">*</span></label>
                        <input type="text" name="nama_lengkap_dosen" class="form-control" value="<?php echo e(old('nama_lengkap_dosen')); ?>" placeholder="Masukkan Nama Lengkap">
                    </div>
                    <div class="form-group">
                        <label>NIDN <span class="required">*</span></label>
                        <input type="text" name="nidn" class="form-control" value="<?php echo e(old('nidn')); ?>" placeholder="Masukkan NIDN">
                    </div>
                    <div class="form-group">
                        <label>Email <span class="required">*</span></label>
                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="Masukkan Email">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="program_studi" class="form-control" value="<?php echo e(old('program_studi')); ?>" placeholder="Masukkan Program Studi">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tempat_lahir" class="form-control" value="<?php echo e(old('tempat_lahir')); ?>" placeholder="Masukkan Tempat Lahir">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_telp" class="form-control" value="<?php echo e(old('no_telp')); ?>" placeholder="Masukkan Nomor Telepon">
                    </div>
                    <div class="form-group full-width">
                        <label>Alamat</label>
                        <textarea name="alamat" class="form-control" rows="3" placeholder="Masukkan Alamat Lengkap"><?php echo e(old('alamat')); ?></textarea>
                    </div>
                    <div class="form-group full-width">
            ...
            <div class="form-section" id="mahasiswaForm" style="display: none;">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        <label>Nama Lengkap <span class="required">*</span></label>
                        <input type="text" name="nama_lengkap_mhs" class="form-control" value="<?php echo e(old('nama_lengkap_mhs')); ?>" placeholder="Masukkan Nama Lengkap">
                    </div>
                    <div class="form-group">
                        <label>NIM <span class="required">*</span></label>
                        <input type="text" name="nim" class="form-control" value="<?php echo e(old('nim')); ?>" placeholder="Masukkan NIM">
                    </div>
                    <div class="form-group">
                        <label>NIK</label>
                        <input type="text" name="nik" class="form-control" value="<?php echo e(old('nik')); ?>" placeholder="Masukkan NIK">
                    </div>
                    <div class="form-group">
                        <label>Email <span class="required">*</span></label>
                        <input type="email" name="email" class="form-control" value="<?php echo e(old('email')); ?>" placeholder="Masukkan Email">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_kelamin_mhs" class="form-control">
                            <option value="">Pilih Jenis Kelamin</option>
                            <option value="Laki-laki" <?php echo e(old('jenis_kelamin_mhs') == 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                            <option value="Perempuan" <?php echo e(old('jenis_kelamin_mhs') == 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Tempat Lahir</label>
                        <input type="text" name="tempat_lahir_mhs" class="form-control" value="<?php echo e(old('tempat_lahir_mhs')); ?>" placeholder="Masukkan Tempat Lahir">
                    </div>
                    <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir_mhs" class="form-control" value="<?php echo e(old('tanggal_lahir_mhs')); ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="agama_mhs" class="form-control">
                            <option value="">Pilih Agama</option>
                            <option value="Islam" <?php echo e(old('agama_mhs') == 'Islam' ? 'selected' : ''); ?>>Islam</option>
                            <option value="Kristen" <?php echo e(old('agama_mhs') == 'Kristen' ? 'selected' : ''); ?>>Kristen</option>
                            <option value="Katolik" <?php echo e(old('agama_mhs') == 'Katolik' ? 'selected' : ''); ?>>Katolik</option>
                            <option value="Hindu" <?php echo e(old('agama_mhs') == 'Hindu' ? 'selected' : ''); ?>>Hindu</option>
                            <option value="Buddha" <?php echo e(old('agama_mhs') == 'Buddha' ? 'selected' : ''); ?>>Buddha</option>
                            <option value="Konghucu" <?php echo e(old('agama_mhs') == 'Konghucu' ? 'selected' : ''); ?>>Konghucu</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>No. Telepon</label>
                        <input type="text" name="no_telp_mhs" class="form-control" value="<?php echo e(old('no_telp_mhs')); ?>" placeholder="Masukkan Nomor Telepon">
                    </div>
                    <div class="form-group full-width">
                        <label>Alamat</label>
                        <textarea name="alamat_mhs" class="form-control" rows="3" placeholder="Masukkan Alamat Lengkap"><?php echo e(old('alamat_mhs')); ?></textarea>
                    </div>
                    <div class="form-group">
                        <label>Biaya Masuk</label>
                        <input type="number" name="biaya_masuk" class="form-control" value="<?php echo e(old('biaya_masuk')); ?>" placeholder="Masukkan Biaya Masuk">
                    </div>
                    <div class="form-group">
                        <label>Status Mahasiswa</label>
                        <select name="status_mahasiswa" class="form-control">
                            <option value="">Pilih Status</option>
                            <option value="Aktif" <?php echo e(old('status_mahasiswa') == 'Aktif' ? 'selected' : ''); ?>>Aktif</option>
                            <option value="Tidak Aktif" <?php echo e(old('status_mahasiswa') == 'Tidak Aktif' ? 'selected' : ''); ?>>Tidak Aktif</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Status Sync</label>
                        <select name="status_sync" class="form-control">
                            <option value="Belum Sync" <?php echo e(old('status_sync') == 'Belum Sync' ? 'selected' : ''); ?>>Belum Sync</option>
                            <option value="Sudah Sync" <?php echo e(old('status_sync') == 'Sudah Sync' ? 'selected' : ''); ?>>Sudah Sync</option>
                        </select>
                    </div>
                    <div class="form-group full-width">
                        <label>Pas Foto</label>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/manajemenUser/create.blade.php ENDPATH**/ ?>