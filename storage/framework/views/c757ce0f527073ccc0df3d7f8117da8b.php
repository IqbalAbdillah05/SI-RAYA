...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadMataKuliah() {
        ...
        if (prodiId && semester) {
            ...
            const url = `<?php echo e(route('dosen.inputNilai.getMatakuliah')); ?>?prodi_id=${prodiId}&semester=${semester}`;
    ...
    loadMahasiswaBtn.addEventListener('click', function() {
        ...
        const url = `<?php echo e(route('dosen.mahasiswa.byProdiSemester')); ?>?prodi_id=${prodiId}&semester=${semester}&matakuliah_id=${matakuliahId}`;
        console.log('Fetch URL:', url);
