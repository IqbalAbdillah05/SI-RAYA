    ...
    <div class="doc-footer">
        <div class="help-section">
            ...
            <div class="help-links">
                <a href="<?php echo e(route('dosen.bantuan.index')); ?>" class="help-link">
                    ❓ Lihat FAQ
                </a>
                <a href="<?php echo e(route('dosen.bantuan.kontak')); ?>" class="help-link">
                    📞 Hubungi Admin
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.dosen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/dosen/bantuan/dokumentasi.blade.php ENDPATH**/ ?>