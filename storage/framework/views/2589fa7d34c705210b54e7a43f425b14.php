...
<head>
    <meta charset="utf-8">
    <title>KHS - <?php echo e($mahasiswa->nim); ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <img src="<?php echo e(public_path('storage/logo/kopsurat.jpg')); ?>" alt="Kop Surat STAI RAYA" style="width: 100%; height: auto;">
            </div>
        </div>
    ...
    <div class="info-section">
        <div class="info-grid">
            <div class="info-row">
                ...
                <div class="info-value"><?php echo e($mahasiswa->nim); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Nama Mahasiswa</div>
                <div class="info-separator">:</div>
                <div class="info-value"><?php echo e($mahasiswa->nama_lengkap); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Program Studi</div>
                <div class="info-separator">:</div>
                <div class="info-value"><?php echo e($mahasiswa->prodi->nama_prodi ?? '-'); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Semester</div>
                <div class="info-separator">:</div>
                <div class="info-value"><?php echo e($khs->semester); ?></div>
            </div>
            <div class="info-row">
                <div class="info-label">Tahun Ajaran</div>
                <div class="info-separator">:</div>
                <div class="info-value"><?php echo e($khs->tahun_ajaran ?? '-'); ?></div>
            </div>
        </div>
    </div>
        ...
        <div class="summary-grid">
            <div class="summary-row">
                <div class="summary-cell">
                    ...
                    <div class="summary-value"><?php echo e($khs->total_sks ?? 0); ?></div>
                </div>
                <div class="summary-cell">
                    <div class="summary-label">IP Semester (IPS)</div>
                    <div class="summary-value"><?php echo e(number_format($khs->ips ?? 0, 2)); ?></div>
                </div>
                <div class="summary-cell">
                    <div class="summary-label">IP Kumulatif (IPK)</div>
                    <div class="summary-value"><?php echo e(number_format($khs->ipk ?? 0, 2)); ?></div>
                </div>
                <div class="summary-cell">
            ...
            <?php $__currentLoopData = $khs->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge-nilai nilai-<?php echo e(strtolower(str_replace(['+', '-'], ['-plus', '-minus'], $detail->nilai_huruf ?? 'e'))); ?>">
    ...
    <div class="footer">
        <div class="signature-section">
            <div>Jember, <?php echo e(date('d F Y')); ?></div>
            ...
            <div style="margin-top: 3px; font-weight: bold; font-size: 9pt;">
                <?php if($mahasiswa->prodi && $mahasiswa->prodi->ketua_prodi): ?>
                    <?php echo e($mahasiswa->prodi->ketua_prodi); ?>

                <?php else: ?>
                    (...........................)
                <?php endif; ?>
            </div>
            <?php if($mahasiswa->prodi && $mahasiswa->prodi->nidn_ketua_prodi): ?>
                <div style="margin-top: 2px; font-size: 8pt; color: #555;">
                    NIDN: <?php echo e($mahasiswa->prodi->nidn_ketua_prodi); ?>
...
<?php /**PATH C:\laragon\www\si-raya\resources\views/mahasiswa/khs/pdf.blade.php ENDPATH**/ ?>