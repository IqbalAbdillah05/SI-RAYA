...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card-info" style="background: linear-gradient(135deg, #0B6623 0%, #0a5a1f 100%); border: none; padding: 24px; border-radius: 12px; margin-bottom: 20px; color: white;">
        <div>
            ...
            <p style="margin: 0; opacity: 0.95; font-size: 14px;">
                Ubah mata kuliah yang akan diambil semester <?php echo e($krs->semester); ?>
    ...
    <form action="<?php echo e(route('mahasiswa.krs.update', $krs->id)); ?>" method="POST" id="krsForm">
        <?php echo csrf_field(); ?>
                ...
                <div class="card-simple">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="semester" value="<?php echo e($krs->semester); ?>" readonly>
                        </div>
                        <div class="col-md-6">
                            <label for="tahun_ajaran" class="form-label">Tahun Ajaran <span class="text-danger">*</span></label>
                            <input type="text" class="form-control <?php $__errorArgs = ['tahun_ajaran'];
...
unset($__errorArgs, $__bag); ?>" 
                                   ...
                                   value="<?php echo e(old('tahun_ajaran', $krs->tahun_ajaran)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if($krs->status_validasi == 'pending'): ?>
                ...
                <?php if($mataKuliahList->count() > 0): ?>
                    <?php $__currentLoopData = $mataKuliahList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mataKuliah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="matakuliah-item-krs" onclick="toggleMataKuliah(<?php echo e($mataKuliah->id); ?>)">
                            <div class="d-flex align-items-center gap-3 flex-grow-1">
                                <input type="checkbox" 
                                       class="matakuliah-checkbox-krs" 
                                       name="mata_kuliah_ids[]" 
                                       value="<?php echo e($mataKuliah->id); ?>" 
                                       id="matakuliah_<?php echo e($mataKuliah->id); ?>"
                                       data-sks="<?php echo e($mataKuliah->sks ?? 0); ?>"
                                       onchange="updateTotalSks()"
                                       <?php echo e(in_array($mataKuliah->id, $selectedMataKuliahIds) ? 'checked' : ''); ?>>
                                
                                <div class="flex-grow-1">
                                    <div class="matakuliah-title-krs">
                                        <?php echo e($mataKuliah->kode_matakuliah ?? '-'); ?> - <?php echo e($mataKuliah->nama_matakuliah ?? '-'); ?>

                                    </div>
                                    <div class="matakuliah-meta-krs">
                                        <span><i class="fas fa-layer-group"></i> Semester <?php echo e($mataKuliah->semester ?? '-'); ?></span>
                                    </div>
                                </div>
                                
                                <div class="sks-badge-krs">
                                    <?php echo e($mataKuliah->sks ?? 0); ?> SKS
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-4">
                <div class="total-sks-card-krs">
                    ...
                    <div class="d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('mahasiswa.krs.show', $krs->id)); ?>" class="btn-secondary-krs">
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/mahasiswa/krs/edit.blade.php ENDPATH**/ ?>