...
<?php $__env->startSection('title', 'Edit Kartu Hasil Studi (KHS)'); ?>
...
<div class="khs-edit">
    ...
    <div class="form-container">
        <form action="<?php echo e(route('admin.khs.update', $khs)); ?>" method="POST" id="khsForm">
            <?php echo csrf_field(); ?>
                ...
                <div class="form-grid">
                        ...
                        <select name="mahasiswa_id" class="form-control" id="mahasiswa_id">
                            ...
                            <?php $__currentLoopData = $mahasiswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mahasiswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($mahasiswa->id); ?>" 
                                    <?php echo e($khs->mahasiswa_id == $mahasiswa->id ? 'selected' : ''); ?>>
                        ...
                        <select name="prodi_id" class="form-control" id="prodi_id">
                            ...
                            <?php $__currentLoopData = $prodis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($prodi->id); ?>" 
                                    <?php echo e($khs->prodi_id == $prodi->id ? 'selected' : ''); ?>>
                        ...
                        <select name="semester" class="form-control" id="semester">
                            ...
                            <?php for($i = 1; $i <= 14; $i++): ?>
                                <option value="<?php echo e($i); ?>" 
                                    <?php echo e($khs->semester == $i ? 'selected' : ''); ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tahun_ajaran" class="form-control" 
                               ...
                               value="<?php echo e($khs->tahun_ajaran); ?>" required>
                    </div>
                </div>
            </div>
                ...
                <div id="mataKuliahContainer">
                    ...
                    <div class="mata-kuliah-row form-grid" data-row-index="<?php echo e($index); ?>">
                        <div class="form-group">
                            ...
                            <select name="mata_kuliah[<?php echo e($index); ?>]" class="form-control mata-kuliah-select" required>
                                <option value="">Pilih Mata Kuliah</option>
                                <?php $__currentLoopData = $mataKuliah[$khs->mahasiswa_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="nilai_mahasiswa[<?php echo e($index); ?>]" class="form-control nilai-mahasiswa-select">
                                <option value="">Pilih Nilai (Opsional)</option>
                                <?php $__currentLoopData = $nilaiMahasiswa[$khs->mahasiswa_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($nm->id); ?>"
                                        data-mk-id="<?php echo e($nm->mata_kuliah_id); ?>"
                                        data-nilai="<?php echo e($nm->nilai_angka); ?>"
                                        data-sks="<?php echo e($nm->mata_kuliah->sks); ?>"
                                        <?php echo e($detail->nilai_mahasiswa_id == $nm->id ? 'selected' : ''); ?>>
                                        <?php echo e($nm->mata_kuliah->nama_matakuliah); ?> - Nilai: <?php echo e($nm->nilai_angka); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="nilai_angka[<?php echo e($index); ?>]" class="form-control" 
                                   min="0" max="100" step="0.01" value="<?php echo e($detail->nilai_angka); ?>">
                        </div>
                        <div class="form-group">
                            <label>SKS <span class="required">*</span></label>
                            <input type="number" name="sks[<?php echo e($index); ?>]" class="form-control" 
                                   min="1" max="6" required value="<?php echo e($detail->sks); ?>">
                        </div>
                        <div class="form-group remove-button-group">
                            <button type="button" class="btn btn-danger remove-mata-kuliah" 
                                    style="display: <?php echo e($khs->details->count() > 1 ? 'inline-flex' : 'none'); ?>;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        let rowCounter = <?php echo e($khs->details->count()); ?>;
        ...
        mahasiswaSelect.addEventListener('change', function() {
            ...
            const selectedMahasiswa = <?php echo json_encode($mahasiswas, 15, 512) ?>.find(m => m.id == selectedMahasiswaId);
            ...
            <?php $__currentLoopData = $khs->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                addCourseRow(
                    '<?php echo e($detail->mata_kuliah_id); ?>', 
                    '<?php echo e($detail->nilai_mahasiswa_id); ?>', 
                    '<?php echo e($detail->nilai_angka); ?>', 
                    '<?php echo e($detail->sks); ?>'
                );
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/khs/edit.blade.php ENDPATH**/ ?>