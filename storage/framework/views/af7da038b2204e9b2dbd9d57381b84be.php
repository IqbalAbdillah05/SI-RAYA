...
<?php $__env->startSection('title', 'Tambah Blokir Mahasiswa'); ?>
...
<div class="blokir-mahasiswa-create">
    ...
    <div class="form-container">
        <form action="<?php echo e(route('admin.blokir-mahasiswa.store')); ?>" method="POST" id="blokirForm" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_blokir" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/blokir-mahasiswa/create.blade.php ENDPATH**/ ?>