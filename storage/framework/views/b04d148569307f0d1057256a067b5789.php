<?php $__env->startSection('title', 'Tambah Presensi'); ?>
...
<div class="presensi-container">
    <div class="page-header">
        ...
        <p style="margin: 8px 0 0 0; color: #666;">
            Presensi ke-<?php echo e($jumlahPresensiHariIni + 1); ?> dari 2 hari ini
        </p>
    </div>
    ...
    <div class="card-simple">
        ...
        <form action="<?php echo e(route('dosen.presensi.store')); ?>" method="POST" enctype="multipart/form-data" id="formPresensi">
            <?php echo csrf_field(); ?>
                ...
                <select name="lokasi_id" id="lokasi_id" class="form-control" required>
                    ...
                    <?php $__currentLoopData = $lokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($item->id); ?>" 
                            ...
                            data-radius="<?php echo e($item->radius); ?>"
                            <?php echo e((old('lokasi_id', $selectedLokasiId ?? '') == $item->id) ? 'selected' : ''); ?>>
                            <?php echo e($item->nama_lokasi); ?> (Radius: <?php echo e(number_format($item->radius, 0)); ?>m)
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" required onchange="handleStatusChange()">
                    <option value="hadir" <?php echo e(old('status', 'hadir') == 'hadir' ? 'selected' : ''); ?>>Hadir</option>
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" 
                          ...
                          class="form-control" 
                          rows="4" 
                          placeholder="Berikan keterangan tambahan jika diperlukan"><?php echo e(old('keterangan')); ?></textarea>
            ...
            <input type="hidden" 
                   name="presensi_ke" 
                   id="presensi_ke" 
                   value="<?php echo e($jumlahPresensiHariIni == 0 ? 'ke-1' : 'ke-2'); ?>"
            >

            <div class="button-group">
                <a href="<?php echo e(route('dosen.presensi.index')); ?>" class="btn-secondary">
                    Batal
                </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dosen', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/dosen/presensi/create.blade.php ENDPATH**/ ?>