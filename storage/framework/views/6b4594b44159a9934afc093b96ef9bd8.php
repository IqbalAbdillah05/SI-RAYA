...
<?php $__env->startSection('title', 'Tambah Lokasi Presensi'); ?>
...
<div class="lokasi-create">
    ...
    <div class="form-container">
        <form action="<?php echo e(route('admin.lokasi.store')); ?>" method="POST" id="lokasiForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <input type="text" name="nama_lokasi" class="form-control" value="<?php echo e(old('nama_lokasi')); ?>" placeholder="Contoh: Kampus Utama, Gedung A, dll" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="latitude" id="latitude" class="form-control" value="<?php echo e(old('latitude')); ?>" placeholder="-6.200000" step="any" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="longitude" id="longitude" class="form-control" value="<?php echo e(old('longitude')); ?>" placeholder="106.816666" step="any" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group full-width">
                        ...
                        <input type="number" name="radius" id="radius" class="form-control" value="<?php echo e(old('radius', 100)); ?>" placeholder="100" min="10" max="10000" required>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/lokasi/create.blade.php ENDPATH**/ ?>