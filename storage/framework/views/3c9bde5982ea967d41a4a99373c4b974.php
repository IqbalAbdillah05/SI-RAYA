        ...
        <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 1rem;">
            <div>
                ...
                <p style="margin: 0; opacity: 0.95; font-size: 14px;">
                    Semester <?php echo e($krs->semester); ?> - Tahun Ajaran <?php echo e($krs->tahun_ajaran); ?>

                </p>
            </div>
            <div style="display: flex; gap: 8px;">
                <?php if($krs->status_validasi != 'Disetujui'): ?>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card-simple">
                ...
                <div class="info-grid-krs">
                    <div class="info-row-krs">
                        ...
                        <div class="info-value-krs"><?php echo e($mahasiswa->nim); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Nama</div>
                        <div class="info-value-krs"><?php echo e($mahasiswa->nama_lengkap); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Program Studi</div>
                        <div class="info-value-krs"><?php echo e($mahasiswa->prodi->nama_prodi ?? '-'); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Semester</div>
                        <div class="info-value-krs"><?php echo e($krs->semester); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Tahun Ajaran</div>
                        <div class="info-value-krs"><?php echo e($krs->tahun_ajaran); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Tanggal Pengisian</div>
                        <div class="info-value-krs"><?php echo e(\Carbon\Carbon::parse($krs->tanggal_pengisian)->format('d F Y')); ?></div>
                    </div>
                    <div class="info-row-krs">
                        <div class="info-label-krs">Status Validasi</div>
                        <div class="info-value-krs">
                            <?php if($krs->status_validasi == 'Menunggu'): ?>
                                <span class="krs-badge badge-pending">
                                    <i class="fas fa-clock me-1"></i>Menunggu Validasi
                                </span>
                            <?php elseif($krs->status_validasi == 'Disetujui'): ?>
                    ...
                    <table class="khs-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $krs->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><strong><?php echo e($detail->mataKuliah->kode_matakuliah ?? '-'); ?></strong></td>
                                    ...
                                    <td class="text-center">
                                        <span class="badge-nilai" style="background-color: #d4edda; color: #155724; padding: 4px 12px; border-radius: 12px; font-weight: 600;">
                                            <?php echo e($detail->mataKuliah->sks ?? 0); ?> SKS
                                        </span>
                                    </td>
                                    <td class="text-center"><?php echo e($detail->mataKuliah->semester ?? '-'); ?></td>
                                </tr>
                        ...
                        <tfoot>
                            <tr class="total-row">
                                ...
                                <td class="text-center"><strong><?php echo e($totalSks); ?> SKS</strong></td>
                                <td colspan="3"></td>
                            </tr>
                        </tfoot>
                    </table>
            ...
            <div style="margin-top: 20px; display: flex; gap: 10px; flex-wrap: wrap;">
                <a href="<?php echo e(route('mahasiswa.krs.index')); ?>" class="btn-action-krs btn-secondary-show">
                    <i class="fas fa-arrow-left"></i>
                    <span>Kembali</span>
                </a>
                
                <?php if($krs->status_validasi != 'approved'): ?>
                    <a href="<?php echo e(route('mahasiswa.krs.edit', $krs->id)); ?>" class="btn-action-krs btn-edit-show">
                        <i class="fas fa-edit"></i>
                        <span>Edit KRS</span>
                    </a>
                    
                    <form action="<?php echo e(route('mahasiswa.krs.destroy', $krs->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus KRS ini?')">
                        <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-4">
            <div class="total-card-show">
                ...
                <div class="summary-item-show">
                    ...
                    <strong><?php echo e($krs->details->count()); ?> MK</strong>
                </div>
                
                <div class="total-sks-large">
                    <div style="opacity: 0.8; font-size: 14px; margin-bottom: 8px;">Total SKS</div>
                    <div style="font-size: 48px; font-weight: 700;"><?php echo e($totalSks); ?></div>
...
<?php echo $__env->make('layouts.mahasiswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/mahasiswa/krs/show.blade.php ENDPATH**/ ?>