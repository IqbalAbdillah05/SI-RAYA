...
<?php $__env->startSection('title', 'Manajemen Presensi Dosen'); ?>

<?php $__env->startSection('content'); ?>
<div class="presensi-management">
    <!-- Header -->
    <div class="page-header">
        <h1>Manajemen Presensi Dosen</h1>
    </div>
    ...
    <!-- Controls -->
    <form method="GET" action="<?php echo e(route('admin.manajemen-presensi-dosen.index')); ?>">
        <div class="controls">
            <div class="left-controls">
                ...
                <div class="export-buttons">
                    <a href="<?php echo e(route('admin.manajemen-presensi-dosen.export', request()->all())); ?>" 
    ...
    <div class="table-wrapper">
        <table class="data-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $presensiDosens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td><?php echo e($presensiDosens->firstItem() + $index); ?></td>
                    <td>
                        <div class="user-info">
                            <div>
                                <strong><?php echo e($item->dosen->nama_lengkap ?? $item->dosen->name); ?></strong>
                                <small><?php echo e($item->dosen->nidn); ?></small>
                            </div>
                        </div>
                    </td>
                    <td>
                    ...
                    <td><?php echo e($item->waktu_presensi->format('d/m/Y H:i')); ?></td>
                    <td>
                    ...
                    <td><?php echo e($item->presensi_ke ?? '-'); ?></td>
                    <td><?php echo e($item->keterangan ?: '-'); ?></td>
                    <td>
                        <?php if($item->jarak_masuk): ?>
                            <?php echo e(number_format($item->jarak_masuk, 2)); ?> m
                        <?php else: ?>
                            -
                        <?php endif; ?>
                    </td>
                    <td>
                        <div class="action-buttons">
                            <a href="<?php echo e(route('admin.manajemen-presensi-dosen.show', $item)); ?>" 
                               class="btn-action btn-view" title="Lihat Detail">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="<?php echo e(route('admin.manajemen-presensi-dosen.edit', $item)); ?>" 
                               class="btn-action btn-edit" title="Edit">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="<?php echo e(route('admin.manajemen-presensi-dosen.destroy', $item)); ?>" 
                                  method="POST" 
    ...
    <!-- Pagination Info -->
    <?php if($presensiDosens->hasPages() || $presensiDosens->total() > 0): ?>
    <div class="pagination-wrapper">
        <div class="pagination-info">
            Menampilkan <?php echo e($presensiDosens->firstItem() ?? 0); ?> sampai <?php echo e($presensiDosens->lastItem() ?? 0); ?> dari <?php echo e($presensiDosens->total()); ?> data
        </div>
        <div class="pagination-links">
            <?php echo e($presensiDosens->links()); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/manajemenPresensiDosen/index.blade.php ENDPATH**/ ?>