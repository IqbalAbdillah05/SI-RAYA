...
<div class="prodi-form">
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form action="<?php echo e(route('admin.manajemen-prodi.update', $prodi->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                        ...
                        <?php $__currentLoopData = $jenjangOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($key); ?>" <?php echo e(old('jenjang', $prodi->jenjang) == $key ? 'selected' : ''); ?>>
                                <?php echo e($value); ?>
...
unset($__errorArgs, $__bag); ?>" 
                           id="ketua_prodi" 
                           name="ketua_prodi" 
                           value="<?php echo e(old('ketua_prodi', $prodi->ketua_prodi)); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                           ...
                           value="<?php echo e(old('nidn_ketua_prodi', $prodi->nidn_ketua_prodi)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('admin.manajemen-prodi.index')); ?>" class="btn btn-cancel">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\si-raya\resources\views/admin/manajemenProdi/edit.blade.php ENDPATH**/ ?>